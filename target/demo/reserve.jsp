...
<body>
    ...
    <tr>
        <td>
            <%-- Add the room number before room_info for roomIndex=0 --%>
            <%= roomIndex == 0 ? "部屋番号：" + room_info.get(roomIndex)[0] : room_info.get(roomIndex)[0] %><br>

            <%-- Loop through room_info starting from index 1 --%>
...
<% } %>
    ...
    <script>
        ...
        // Add validation for reservation title and purpose
        ...
        // Validate end time not earlier than start time
